...
contract LockEarn is ERC20Detailed, Ownable {
    ...
    string public _name = "LockEarn";
    string public _symbol = "LET";
    ...
    constructor() ERC20Detailed("LockEan", "LET", uint8(DECIMALS)) Ownable() {
        ...
        lpReceiver = 0xaa4bd6fCaeC128B45c28217bfea5F9bC8aa769B1;
        rewardPoolReceiver = 0xA6b676B2D941AaaEf204394E0b188B63866b5612;
        treasuryReceiver = 0x64D24F66CF118932E03D50D62F6B9a7045DAF84c;
        insuranceReceiver = 0xAE75Cf7aB827BB40acc3a67702cfd4662C871AbB;
